...
public class JposConfig {
    ...
    public static void configure(String deviceName, String portName, Context context) throws Exception {
    ...
    public static void configure(String deviceName, String portName, Context context, String portType, String protocol) throws Exception {
    ...
    public static void configure(String deviceName, Context context, Map<String, String> props) throws Exception {
